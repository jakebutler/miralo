...
const repoRoot = process.env.MIRALO_REPO_ROOT
  ? path.resolve(process.env.MIRALO_REPO_ROOT)
  : path.resolve(scriptDir, "../..");
const outputDir = process.env.MIRALO_OUTPUT_DIR
  ? path.resolve(process.env.MIRALO_OUTPUT_DIR)
  : path.resolve(repoRoot, "demo-orchestration/runtime/recordings");
